<html>
  ...
  <body>
    ...
    <table id="customers">
      ...
      <tr>
        <td><?php echo $order->billing_first_name . " " .  $order->shipping_last_name ; ?> </td>
      ...
      <tr>
          ...
          <td> Order Number: <i><b><?php echo $order->id ?> </b></i> </td>
      </tr>

      <tr>
          <td><?php echo $order->billing_address_2 ;   ?></td>
          <td><?php echo $order->shipping_address_2 ;  ?></td>
          <td> Order Date: <i>  <?php echo $order->order_date ?> </i> </td>
      </tr>

        <tr>
          <td><?php echo  $order->billing_city . $order->billing_postcode  ; ?></td>
          <td><?php echo  $order->shipping_city . $order->shipping_postcode ; ?></td>
          <td> Payment Method: <i> <?php echo $order->payment_method_title ; ?> </i> </td>
        </tr>
    </table>
    <br>
    <br>
